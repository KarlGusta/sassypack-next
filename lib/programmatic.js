...
export const clusters = {
  ...
  industries: { list: industriesData.industries, prefix: "/industries" },
};

// Stacks has no single prefix — entries live under /Nextjs-stack/* and /nextjs/*.
// Each group is routed by its own [slug] page.
export const stackGroups = {
  NextjsStack: { list: stacksData.stacks, prefix: "/Nextjs-stack" },
...
// real /Nextjs-stack/* and /nextjs/* routes; it owns no [slug] route itself).
...
// ── including stackGroups.NextjsStack, stackGroups.nextjs, alternatives ──
...
export function buildMetadata(meta = {}) {
  const {
    title: rawTitle = "SassyPack | Next.js starter kit",
    description = "Launch your SaaS in hours with SassyPack. Pre-built authentication, payments, dashboards, and APIs for Nextjs and Next.js.",
    keywords = [],
