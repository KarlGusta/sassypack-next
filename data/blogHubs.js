...
export const blogHubs = [
  {
    ...
    label: "Development",
    description:
      "Build faster SaaS products with guides on MVP planning, Nextjs, Next.js, dashboards, deployment, and starter-kit architecture.",
    accent: "#C994FF",
    featuredSlugs: [
      ...
      "Nextjs-saas-tutorial-from-scratch-to-deployment",
      "what-is-a-saas-starter-kit-nextjs-Nextjs",
    ...
    keywords: [
      "mvp", "development", "nextjs", "next.js", "Nextjs", "dashboard",
  ...
  },
  {
    ...
    label: "Scaling",
    description:
      "Scale Nextjs and Next.js SaaS products with performance, monitoring, architecture, multi-tenancy, and growth infrastructure guides.",
    accent: "#6366F1",
    featuredSlugs: [
      ...
      "advanced-Nextjs-performance-optimization-scaling-guide",
  ...
  },
  {
    ...
    featuredSlugs: [
      ...
      "integrate-paystack-nextjs-Nextjs-saas-guide",
